...
const ImageDropper = (props: Props) => {
  ...
  return (
    <div
      ...
      <button
        className={clsx(
          'rounded-full z-20 asolute py-4 px-8 w-full flex justify-between items-center outline outline-1 outline-gray-200 bg-white text-black  text-sm font-bold shadow-lg',
          {
